react is the javascript library in which components are defined and eventually become HTML.
I used react because renders very quickly, it's easy to test, and enables good coding practice.

How react renders the view timeline: 1) JSX code is written describing a basic application --> 2) JSX is converted into Javascript by the compiler
--> 3) React turns converted JSX into a virtual DOM. ---> 4) Virtual Dom is applied ot real DOM --> 5) Underlying data model is updated -->
